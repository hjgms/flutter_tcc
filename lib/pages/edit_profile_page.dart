...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Container musicStyleSelected(String name) {
    return Container(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      if(snapshot.hasData && snapshot.data!["ok"] == true){
                        ...
                        global.musicStylesList = (snapshot.data!["args"] as List);
                        
                        return ListView.builder(
                          shrinkWrap: true,
                          itemCount: global.musicStylesList.length,
                          itemBuilder: (context, index) {
                            if(global.musicStylesList[index]["selected"] == true){
                              return musicStyleSelected(
                                global.musicStylesList[index]["obj"]["name"]
                              );
                            }
                            return null;
                          },
